...
class CheckOutsControllerTest < ActionController::TestCase
  ...
  test "should create check_out" do
    assert_difference('CheckOut.count') do
      post :create, check_out: { check_out_date: @check_out.check_out_date, item_id: @check_out.item_id, return_date: @check_out.return_date, user_id: @check_out.user_id }
    end
  ...
  test "should update check_out" do
    patch :update, id: @check_out, check_out: { check_out_date: @check_out.check_out_date, item_id: @check_out.item_id, return_date: @check_out.return_date, user_id: @check_out.user_id }
    assert_redirected_to check_out_path(assigns(:check_out))
  end
